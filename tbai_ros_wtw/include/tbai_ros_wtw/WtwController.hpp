...
class RosWtwController : public tbai::WtwController {
   public:
    RosWtwController(const std::string &urdfString, const std::shared_ptr<tbai::StateSubscriber> &stateSubscriberPtr,
